...
} from 'c/flowLauncherComboboxUtils';
import Placeholder_Text from '@salesforce/label/c.joshdaymentlabs_Manual_Reference_Allowed';
import getObjectFields from '@salesforce/apex/ComboBoxController.getObjectFields';

const OUTPUTS_FROM_LABEL = 'Outputs from '; 
export default class flowLauncherComboBox extends LightningElement {
    @api name;
    @api label;
    @api required = false;
